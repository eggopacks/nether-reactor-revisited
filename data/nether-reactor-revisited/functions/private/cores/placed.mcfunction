...
execute if block ~ ~ ~ nether-reactor-revisited:active run summon marker ~ ~ ~ {Tags: ["nether-reactor-revisited.core", "nether-reactor-revisited.active", "nether-reactor-revisited.unstable"], CustomName: '{"text": "Nether Reactor Core"}'}
...
execute unless data storage eggohito:nether-reactor-revisited root.player.mainhand if data storage eggohito:nether-reactor-revisited root.player.offhand run data modify entity @e[tag = nether-reactor-revisited.set_data, limit = 1] data.eggohito.nether-reactor-revisited set from storage eggohito:nether-reactor-revisited root.player.mainhand.tag.eggohito.nether-reactor-revisited

execute if data storage eggohito:nether-reactor-revisited root.player.mainhand run data modify entity @e[tag = nether-reactor-revisited.set_data, limit = 1] data.eggohito.nether-reactor-revisited set from storage eggohito:nether-reactor-revisited root.player.mainhand.tag.eggohito.nether-reactor-revisited
